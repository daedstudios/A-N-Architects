...
const page = () => {
  return (
    <div className="grid md:grid-cols-2 lg:grid-cols-4 grid-cols-[auto] grid-rows-[repeat(9,_22.5rem)] md:grid-rows-[repeat(5,_22.5rem)] lg:grid-rows-[repeat(3,_22.5rem)] px-2 gap-2 min-h-screen text-4xl">
