...
export default function Home() {
  return (
      ...
      <div className="col-span-1 py-2 md:col-span-2 lg:col-span-4 row-span-1 text-[1.75rem] mt-auto"> projekte </div>
           ...
           <>
            <div key={index} className="relative row-span-1 col-span-1" >
                ...
                <Image
                  ...
                  alt={item}
                  fill 
                  className="grayscale hover:grayscale-0 cursor-pointer duration-300"
                  />
