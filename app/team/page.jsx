...
const page = () => {
  return (
    <div className="grid md:grid-cols-2 lg:grid-cols-4 grid-cols-[auto] md:grid-rows-[repeat(6,_18rem)] grid-rows-[repeat(11,_18rem)] lg:grid-rows-[repeat(4,_18rem)] px-2 gap-2 min-h-screen text-4xl">
